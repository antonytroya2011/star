...
<div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Bienvenido a Viviendas Bengi S.A! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">La página donde encontraras tus viviendas mas cercas a la U </span>
              </h3>
              <div class="d-flex">
                      ...
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Ventas</p>
                            <h2 class="text-white"> $8,753.<span class="h5">00</span>
                            </h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-basket bg-inverse-icon-warning"></i>
                        </div>
                        <h6 class="text-white">18.33% El último mes</h6>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                    <div class="card bg-danger">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Margen</p>
                            <h2 class="text-white"> $5,300.<span class="h5">00</span>
                            </h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-cube-outline bg-inverse-icon-danger"></i>
                        </div>
                        <h6 class="text-white">13.21% El último mes</h6>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3 pb-lg-0 pb-xl-3">
                    <div class="card bg-primary">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Ordenes</p>
                            <h2 class="text-white"> $1,753.<span class="h5">00</span>
                            </h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-briefcase-outline bg-inverse-icon-primary"></i>
                        </div>
                        <h6 class="text-white">67.98% El último mes</h6>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-12 col-md-6 stretch-card pb-sm-3 pb-lg-0">
                    <div class="card bg-success">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Afiliate</p>
                            <h2 class="text-white">2368</h2>
                          </div>
                          <i class="card-icon-indicator mdi mdi-account-circle bg-inverse-icon-success"></i>
                        </div>
                        <h6 class="text-white">20.32% El último mes</h6>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-7">
                        <h5>Bengi S.A</h5>
                        <p class="text-muted"> Mira los detalles Dec 2023 - Jul 2024 <a class="text-muted font-weight-medium pl-2" href="#"><u>See Details</u></a>
                        </p>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="card mb-3 mb-sm-0">
                          <div class="card-body py-3 px-4">
                            <p class="m-0 survey-head">Ganáncias</p>
                      ...
                      <div class="col-sm-4">
                        <div class="card mb-3 mb-sm-0">
                          <div class="card-body py-3 px-4">
                            <p class="m-0 survey-head">Ventas</p>
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
                      ...
                      <div class="col-sm-4">
                        <div class="card">
                          <div class="card-body py-3 px-4">
                            <p class="m-0 survey-head">Ordenes</p>
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
                    ...
                    <div class="row">
                      <div class="col-sm-8">
                        <p class="text-muted mb-0"> Las viviendas se arriendan y es por eso que se analiza en todo el contexto para tener un margen de vivienda para la comodidad de usuarios</b>
                        </p>
                      </div>
                      <div class="col-sm-4">
            ...
            <div class="row">
              <div class="col-xl-8 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body px-0 overflow-auto">
                    <h4 class="card-title pl-4">Equipos históricos</h4>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="assets/images/faces/bsc.jpeg" alt="image" />
                                <div class="table-user-name ml-3">
                                  <p class="mb-0 font-weight-medium"> BSC </p>
                                  <small> Activo</small>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="assets/images/faces/ldu.jpeg" alt="image" />
                                <div class="table-user-name ml-3">
                                  <p class="mb-0 font-weight-medium"> LDU </p>
                                  <small>Activo</small>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="assets/images/faces/cse.png" alt="image" />
                                <div class="table-user-name ml-3">
                                  <p class="mb-0 font-weight-medium"> CSE </p>
                                  <small>Activo</small>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="assets/images/faces/dcu.png" alt="image" />
                                <div class="table-user-name ml-3">
                                  <p class="mb-0 font-weight-medium"> DCU </p>
                                  <small>Activo</small>
                                </div>
                              </div>
                            </td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="assets/images/faces/idv.jpeg" alt="image" />
                                <div class="table-user-name ml-3">
                                  <p class="mb-0 font-weight-medium"> IDV </p>
                                  <small>Activo</small>
                                </div>
                              </div>
                            </td>
              ...
              <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="card-title font-weight-medium"> Noticias del momento </div>
                    <p class="text-muted"> Aqui observaras las noticias del mundo del deporte !!! </p>
                    <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                      <img class="survey-img mb-lg-3" src="assets/images/dashboard/ecuador.jpeg" alt="" />
                      <div class="pt-2">
                        <h5 class="mb-0">Ecuador</h5>
                        <p class="mb-0 text-muted">Ve la selección Ecuador</p>
                        <h5 class="mb-0">$600/mo</h5>
                      </div>
                    </div>
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="assets/images/dashboard/copa.jpg" alt="" />
                      <div class="pt-2">
                        <h5 class="mb-0">Copa América</h5>
                        <p class="mb-0 text-muted">Ve los ultimos resultados</p>
                        <h5 class="mb-0">$900/mo</h5>
                      </div>
                    </div>
                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                      <img class="survey-img mb-lg-3" src="assets/images/dashboard/euro.jpg" alt="" />
                      <div class="pt-2">
                        <h5 class="mb-0">Eurocopa</h5>
                        <p class="mb-0 text-muted">Ve los ultimos resultados</p>
